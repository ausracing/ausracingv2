...
export default function JoinPage() {
  ...
  const filteredOpenings = OPENINGS.filter(
    (opening) => activeCategory === "All" || opening.category === activeCategory
  );
  ...
  if (!isHiringOpen) {
    return (
      // ✨ FIX: min-h-[calc(100vh-80px)] forces the page to fill the screen (minus header), hiding the footer below the fold.
        ...
        <div className="max-w-3xl mx-auto px-6 text-center relative z-20 flex flex-col items-center">
          ...
          <div className="w-14 h-14 mb-4 rounded-full bg-white/5 border border-white/10 flex items-center justify-center">
            <svg className="w-6 h-6 text-white/50" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 15v2m-6 4h12a2 2 0 002-2v-8a2 2 0 00-2-2H6a2 2 0 00-2 2v8a2 2 0 002 2zm10-10V7a4 4 0 00-8 0v4h8z" />
            </svg>
          </div>
          ...
          <div className="text-white/60 text-sm md:text-base leading-relaxed mb-6 max-w-xl space-y-4">
            <p>
              Our 2027 FSUK recruitment window has officially closed. We are currently reviewing applications and finalizing our roster. Thank you to everyone who applied! 
            </p>
          ...
          <div className="flex items-center justify-center space-x-6 mb-10">
            {/* LinkedIn */}
            <Link href="https://linkedin.com/company/ausracing" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors duration-300" aria-label="LinkedIn">
            ...
            {/* Instagram */}
            <Link href="https://instagram.com/ausracing" target="_blank" rel="noopener noreferrer" className="text-white/40 hover:text-white transition-colors duration-300" aria-label="Instagram">
              <svg className="w-7 h-7" fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <div className="max-w-[1400px] mx-auto px-6 lg:px-12 relative z-20">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold font-orbitron uppercase tracking-tight text-white leading-[1.1] max-w-4xl">
            Join the <span className="text-primary">2027 AUSRacing</span> FSUK Team
          </h1>
        </div>
        ...
        >
          <p className="text-white/50 text-xs">
            Don&apos;t see your perfect fit but still want to contribute? <br className="hidden sm:block" />
