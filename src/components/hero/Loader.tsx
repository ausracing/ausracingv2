...
export default function Loader({
  ...
  return (
    ...
    <div
      className={`fixed inset-0 z-[120] ${phase === 4 ? "pointer-events-none" : ""}`}
    >
      ...
      <div
        className={`relative z-10 w-full h-full flex flex-col items-center justify-center px-4 transition-opacity duration-300 ${phase === 4 ? "opacity-0" : "opacity-100"}`}
      >
        ...
        <div className="flex items-center justify-center gap-3 md:gap-6 mb-12 md:mb-16 animate-fade-in-up [animation-delay:200ms]">
          ...
          <div className="overflow-visible flex items-center">
            <svg
              viewBox="0 0 260 80"
              className="w-[180px] sm:w-[220px] md:w-[320px] h-auto overflow-visible"
            >
              <text
                y="62"
                fontSize="72"
