      ...
      <div className="flex flex-col justify-center p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-white/10 bg-black">
        ...
        <div className="flex gap-8">
          <div>
            ...
            <div className="text-[8px] font-mono uppercase tracking-widest text-white/50">Team Members</div>
          </div>
          <div>
            <div className="text-[26px] font-semibold font-mono text-white leading-none mb-1">8</div>
            <div className="text-[8px] font-mono uppercase tracking-widest text-white/50">Seasons</div>
          </div>
          <div>
            <div className="text-[26px] font-semibold font-mono text-white leading-none mb-1">6</div>
            <div className="text-[8px] font-mono uppercase tracking-widest text-white/50">Disciplines</div>
          </div>
        </div>
