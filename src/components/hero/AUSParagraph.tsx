    ...
    <section className="grid grid-cols-1 lg:grid-cols-2 min-h-120 w-full border-t border-white/10 relative z-10">
      ...
      <div className="flex flex-col justify-center p-12 lg:p-16 border-b lg:border-b-0 lg:border-r border-white/10 bg-black">
        ...
        <p className="text-[14px] text-white/70 leading-[1.75] mb-6 max-w-lg">
          AUS Racing is the Formula Student team of the American University of
          Sharjah. Every year, a cross-disciplinary team of engineers designs,
          builds, and races a single-seat formula car from scratch — competing
          against universities worldwide.
        </p>

        {/* Stats Row */}
        <div className="flex gap-8">
          <div>
            <div className="text-[26px] font-semibold font-mono text-white leading-none mb-1">
              40+
            </div>
            <div className="text-[8px] font-mono uppercase tracking-widest text-white/50">
              Team Members
            </div>
          </div>
          <div>
